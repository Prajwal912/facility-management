...
const Carousel = () => {
    return (
        <div className='sm:mx-10 my-4 z-0'>
            ...
            <div id="default-carousel" className="relative w-full" data-carousel="slide">
                ...
                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div className=" duration-700 ease-in-out" data-carousel-item>
                        <img src="/assets/bg.png" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                    </div>
                </div>
                ...
                <div className="absolute flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
                    ...
                    <button type="button" className="w-3 h-3 rounded-full border border-white" aria-current="false" aria-label="Slide 4" data-carousel-slide-to="3"></button>
                    <button type="button" className="w-3 h-3 rounded-full border border-white" aria-current="false" aria-label="Slide 5" data-carousel-slide-to="4"></button>
                </div>
